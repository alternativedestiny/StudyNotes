...
<!-- TOC -->autoauto- [JS数据类型](#js数据类型)auto- [定义变量](#定义变量)auto- [操作符](#操作符)auto- [函数](#函数)auto- [执行环境及作用域](#执行环境及作用域)auto- [引用类型](#引用类型)auto    - [Object 类型](#object-类型)auto    - [Array 类型](#array-类型)auto    - [Data 类型](#data-类型)auto    - [RegExp 类型](#regexp-类型)auto    - [Function 类型](#function-类型)auto    - [基本包装类型](#基本包装类型)auto    - [单体内置对象](#单体内置对象)auto- [函数表达式](#函数表达式)auto    - [函数的表达式](#函数的表达式)auto- [未完待续](#未完待续)autoauto<!-- /TOC -->
